...
{
	gub_pipeline_setup_decoding_clock(pipeline, uri, video_index, audio_index, net_clock_addr, net_clock_port, basetime, crop_left, crop_top, crop_right, crop_bottom, useudpsrc, udpport, FALSE);
}
